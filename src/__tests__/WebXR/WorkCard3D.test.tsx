...
jest.mock('@react-three/drei', () => ({
  ...
  Html: ({ children }: { children: React.ReactNode }) => <div data-testid="html-content">{children}</div>,
  Text: ({ children, ...props }: any) => <mesh {...props} data-testid="text-mesh">{children}</mesh>
}))
