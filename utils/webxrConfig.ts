...
export const getCanvasConfig = (quality: Quality) => WEBXR_CONFIG.canvas[quality]
export const getGeometryConfig = (quality: Quality) => WEBXR_CONFIG.geometry.segments[quality]
export const getLightingConfig = (quality: Quality) => WEBXR_CONFIG.lighting[quality]
export const getAnimationConfig = (quality: Quality) => WEBXR_CONFIG.animation[quality]
export const getPerformanceConfig = () => WEBXR_CONFIG.performance.thresholds

// Helper for quality-based feature gates
export const supportsFeature = (quality: Quality, feature: keyof typeof WEBXR_CONFIG.lighting.high): boolean => {
