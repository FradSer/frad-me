    ...
    await page.addInitScript((delay: number) => {
      setTimeout(() => {
        ...
        window.dispatchEvent(
          new CustomEvent('webgl-context-lost', {
          ...
          return originalRequestSession
            ...
            .then((session) => {
              ...
              setTimeout(() => {
                ...
                window.dispatchEvent(
                  new CustomEvent('xr-session-error', {
  ...
  static async simulateProgressivePerformanceDegradation(
    ...
    await page.addInitScript(() => {
      ...
      const interval = setInterval(() => {
        ...
        window.dispatchEvent(
          new CustomEvent('performance-change', {
            detail: {
      ...
      HTMLCanvasElement.prototype.getContext = function (
        ...
        if (type.includes('webgl') && attributes?.xrCompatible) {
          throw new DOMException(
            'WebGL creation failed due to security restrictions',
            'SecurityError',
          );
        }
