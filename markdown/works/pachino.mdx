export const metadata = {
  ...
  nextWork: 'eye-protection-design-handbook',
}
...
Since the new crown virus also plagued 2021, many people like me were unable to travel, and adding the sounds of Cafes in different countries was a great option, so I found the sounds of the varying Cafes in 11 countries. I developed Pachino mainly in the winter when I missed the birdsong of spring, so I added Songs of the Seasons, but eventually, my cat became the biggest fan of the sound.

<WorkSingleImage
  src="/works/pachino/figure-7.png"
  width="1920"
  height="1080"
  alt="Cafe sound from 11 different countries and four season songs."
  position="inline"
/>
